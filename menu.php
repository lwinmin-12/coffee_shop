...
<?php 
    ...
    $dessProducts =$conn->query("SELECT * FROM products WHERE type='desserts'");
    $dessProducts->execute();

    $allDessProducts = $dessProducts->fetchAll(PDO::FETCH_OBJ);

    $drinkProducts =$conn->query("SELECT * FROM products WHERE type='drink'");
    $drinkProducts->execute();

    $allDrinkProducts = $drinkProducts->fetchAll(PDO::FETCH_OBJ);
...
<section class="ftco-section ">
  ...
  <div class="row">
      ...
      <div class="col-md-6">
          ...
          <?php foreach($allDessProducts as $ea) : ?>
            <div class="pricing-entry d-flex ftco-animate">
              <div class="img" style="background-image: url(<?= url("images/".$ea->image) ?>);"></div>
              <div class="desc pl-3">
                  <div class="d-flex text align-items-center">
                      <h3><span><?= $ea->name ?></span></h3>
                      <span class="price">$<?= $ea->price ?></span>
                  </div>
                  <div class="d-block">
                      <p><?= $ea->description ?></p>
                  </div>
      ...
      <div class="col-md-6">
          ...
          <?php foreach($allDrinkProducts as $ea) : ?>
            <div class="pricing-entry d-flex ftco-animate">
              <div class="img" style="background-image: url(<?= url("images/".$ea->image) ?>);"></div>
              <div class="desc pl-3">
                  <div class="d-flex text align-items-center">
...
<section class="ftco-menu mb-5 pb-5 pt-5">
  <div class="container">
                  ...
                  <div class="row">
                    <?php foreach($allDrinkProducts as $ea) : ?>
                        ...
                        <div class="col-md-4 text-center">
                            <div class="menu-wrap">
                                <a href="<?= url("products/productSingle.php?id=".$ea->id) ?>" class="menu-img img mb-4" style="background-image: url(<?= url('images/'.$ea->image) ?>);"></a>
                                <div class="text">
